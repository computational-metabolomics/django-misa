...
def forwards_func(apps, schema_editor):
    ...
    StudySample = apps.get_model('misa', "StudySample")
    ...
    study1 = Study(investigation=investigation1, name='MTBLS144-TEST-CASE', dmastudy=False,
    ...
    assay1_pos = Assay(name='Positive metabolic profiling (FT-ICR)', study=study1)
    ...
    study2 = Study(investigation=investigation2, name='IN-HOUSE-MOGI-TEST-CASE', dmastudy=False,
                  description='Example LC-MS/MS dataset to test MOGI')
    study2.save()

    assay2_pos = Assay(name='Positive metabolic profiling (Q-Exactive)', study=study2)
    ...
    lpe_type3 = ExtractionType(type="Just dilution", description="Some sample types only require dilution" )
    ...
    spe_type5 = SpeType(type="NA", description="Not applicable")
    spe_type5.save()
    ...
    m_protocol3 = MeasurementProtocol(name="Q-Exactive LC-MSMS",
    ...
    check_and_create_model('Bovine', Organism, db_alias)
    ...
    ss1 = StudySample(sampletype=SampleType.objects.filter(type='ANIMAL')[0],
                      ...
                      study_id=study2.id,
                      organism=Organism.objects.filter(name='bovine')[0],
